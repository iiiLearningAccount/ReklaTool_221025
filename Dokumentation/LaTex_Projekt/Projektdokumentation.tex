...
\phantomsection
\thispagestyle{empty}
\pdfbookmark[1]{Durchführungsnachweis}{durchführungsnachweis}
\label{Nachweis}
\includepdf[pages=-]{NachweisUeberDieDurchfuehrung.pdf}
\cleardoublepage

\phantomsection
\thispagestyle{empty}
\pdfbookmark[1]{Erklärung des Prüfungsteilnehmers}{teilnehmererklaerung}
\label{Erklaerung}
\includepdf[pages=-]{ErklaerungDesPruefungsteilnehmers.pdf}
\cleardoublepage
