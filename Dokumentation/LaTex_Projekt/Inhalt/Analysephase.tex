...
% \end{itemize}
Der im Folgenden beschriebenen Prozess wird durch das Schaubild im \Anhang{app:Aktivitaet} dargestellt.\\
...
\Fachbegriff{Break-Even-Point} ablesen. Dieser Zeigt an, ab welchem Zeitpunkt sich das Projekt amortisiert hat.\\
