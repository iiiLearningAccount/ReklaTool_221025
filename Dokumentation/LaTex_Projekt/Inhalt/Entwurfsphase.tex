...
Aus dem Lastenheft (\Anhang{app:Lastenheft}) heraus wurde das Pflichtenheft erstellt. Dieses ist im
\Anhang{app:Pflichtenheft} einsehbar. Es dient zur Kontrolle, ob alle Anforderungen planmäßig
umgesetzt wurden.
\clearpage