...
\acs{HTML}-Dokument. Beides zusammen wird innerhalb des ASP.NET-Ökosystems als \Fachbegriff{Razor}-Syntax
...
\footnote{\url{https://developer.mozilla.org/en-US/docs/Web/Guide/AJAX}, letzter Zugriff: }
...
Dieses passierte über \Fachbegriff{Konstruktorinjektion}. Die Implementierung von .NET Core 
sieht ein Injizieren mittels Konstruktorparameter vor. Gegenüber der Property-Injektion gibt es
...
\url{https://learn.microsoft.com/de-de/dotnet/core/extensions/dependency-injection}, letzter Zugriff: }\\
