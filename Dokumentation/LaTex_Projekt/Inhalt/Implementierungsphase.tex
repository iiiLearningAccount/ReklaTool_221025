...
Bei der Implementierung wurden die in \ref{sec:Entwurfsphase} \nameref{sec:Entwurfsphase} beschriebenen Architekturvorgaben
...
Über das \Fachbegriff{Hashing} des gesamten Cache-Objekts sind die Dateien eindeutig identifizierbar.
...
daher auch in \Fachbegriff{C\#} bereitgestellt und darüber konfiguriert. Siehe Listing.\\
...
und die dazugehörigen Interfaces erstellt. Danach konnten diese in der Datei \Datei{Program.cs}
über \Klasse{builder.Sercices} dem Programm-Container hinzugefügt werden und standen somit 
